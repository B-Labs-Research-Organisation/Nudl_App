...
test("calculateSafeChecksum matches expected for working Safe batch JSON", (t) => {
  const batchJson = {
    version: "1.0",
    chainId: "1",
    createdAt: 1750255509666,
    meta: {
      name: "Transactions Batch",
      description: "",
      txBuilderVersion: "1.18.0",
      createdFromSafeAddress: "0x7eC991e1648B7F1d5fa91ae3688C9f36a5CA6C8B",
    ...
    transactions: [
      {
        ...
        contractInputsValues: {
          to: "0x116Da30d890533516f2683731F9Bd167807448b8",
          value: "1000000",
        },
      },
    ],
  ...
  const expectedChecksum =
    "0xf1966baf2cdc7c68774e5be291e81549cc7438efbceccaad0003bb12f8d30baf";
